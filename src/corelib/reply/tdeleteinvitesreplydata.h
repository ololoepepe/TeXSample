...
public:
    T_CORE_EXPORT friend QDataStream &operator <<(QDataStream &stream, const TDeleteInvitesReplyData &data);
    T_CORE_EXPORT friend QDataStream &operator >>(QDataStream &stream, TDeleteInvitesReplyData &data);
    T_CORE_EXPORT friend QDebug operator <<(QDebug dbg, const TDeleteInvitesReplyData &data);
};
